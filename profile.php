<?php
  if (isset($_GET["Requestsuccess"])) {
    echo '<script type="text/javascript">alert("Request created successfully");</script>';
  }
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3"><?php echo explode(" ",$_SESSION["uname"])[0]?> <sup></sup></div>
            </a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="methods.php?report=1" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fa fa-download fa-sm text-white-50"></i> Generate Report</a>
                    </div>

                    <?php
                      $sql = "SELECT sum(amount) as amt from donations where from_email='$email'";
                      $result = $conn->query($sql);
                      $row = $result->fetch_assoc();
                      $donations_made = $row["amt"];
                      if ($donations_made==NULL) {
                        $donations_made = "0";
                      }

                      $sql2 = "SELECT sum(amount) as amt2 from donations where to_email='$email'";
                      $result2 = $conn->query($sql2);
                      $row2 = $result2->fetch_assoc();
                      $donations_recieved = $row2["amt2"];
                      if ($donations_recieved==NULL) {
                        $donations_recieved = "0";
                      }

                      $sql = "SELECT count(listing_ID) as cnt from listings where fk_email='$email' and reached='YES'";
                      $result = $conn->query($sql);
                      $row = $result->fetch_assoc();
                      $completed = $row["cnt"];

                      $sql = "SELECT count(listing_ID) as num from listings where fk_email='$email'";
                      $result = $conn->query($sql);
                      $row = $result->fetch_assoc();
                      $total_listings = $row["num"];
                    ?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Donation Made</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rs. <?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $donations_made) ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Donation Received</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rs. <?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $donations_recieved) ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fa fa-rupee-sign fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Your total Requests</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $total_listings ?></div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <!-- Area Chart -->
                        <div class="col-xl-12 col-lg-12 pl-5 pr-5">
    ...
    <script src="assets/bootstrap/js/chart-area-demo.js"></script>
    <script src="assets/bootstrap/js/chart-pie-demo.js"></script>
    ...
    $sql = "SELECT * from donations where from_email='$umail' order by date_time ASC";
    $result = $conn->query($sql);
